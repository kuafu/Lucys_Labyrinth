...
public:
    ...
    Maze() : playerRow(14), playerCol(0), lastDirection('s'), isDialogueBoxDisplayed(false), dialogueBoxState(1), startupScreenDisplayed(true) {
        ...
        if (!doorInteractBuffer.loadFromFile("../content/sound/door_interact.wav")) {
    ...
    void loadTextures() {
        startupScreenTexture.loadFromFile("../content/textures/startup_screen.png");
        textures[EMPTY].loadFromFile("../content/textures/floorx64.png");
        textures[WALL].loadFromFile("../content/textures/wallx64.png");
        textures[DOOR].loadFromFile("../content/textures/doorx64.png");
        textures[EXIT].loadFromFile("../content/textures/babax64.png");
        playerTextures[0].loadFromFile("../content/textures/babie_floor_eastx64.png");
        playerTextures[1].loadFromFile("../content/textures/babie_floor_southx64.png");
        playerTextures[2].loadFromFile("../content/textures/babie_floor_westx64.png");
        playerTextures[3].loadFromFile("../content/textures/babie_floor_northx64.png");
        dialogueBoxTexture.loadFromFile("../content/textures/dialogue_box_large.png");
        doorTexture.loadFromFile("../content/textures/door.png");
        thinkingDoorTexture.loadFromFile("../content/textures/door_thinking.png");
        endScreenTexture.loadFromFile("../content/textures/end_screen.png");
        youLoseTexture.loadFromFile("../content/textures/you_lose.png");
    }
    ...
    void displayDialogueBox(sf::RenderWindow& window, int doorRow, int doorCol, bool isLiar) {
        ...
        font.loadFromFile("../content/fonts/PAPYRUS.ttf");
    ...
    void showEndScreen(sf::RenderWindow& window) {
        ...
        playerTextures[0].loadFromFile("../content/textures/sweepyx64.png");
        playerTextures[1].loadFromFile("../content/textures/sweepyx64.png");
        playerTextures[2].loadFromFile("../content/textures/sweepyx64.png");
        playerTextures[3].loadFromFile("../content/textures/sweepyx64.png");
...
int main() {
    sf::RenderWindow window(sf::VideoMode(WINDOW_WIDTH_2K, WINDOW_HEIGHT_2K), "Lucy's Labyrinth", sf::Style::Default);
	window.setFramerateLimit(60);
	window.setVerticalSyncEnabled(true);
    sf::Music music;
    if (!music.openFromFile("../content//sound/music.wav")) {
        return 1;
    }
    music.setLoop(true);
    ...
    for (const auto& entry : std::filesystem::directory_iterator("../content//model"))
    {
        ...
        while (window.pollEvent(event)) {
            if (event.type == sf::Event::Closed) {
                ...
                if (event.key.code == sf::Keyboard::F11) {
					if (window.getSize() == sf::Vector2u(WINDOW_WIDTH_2K, WINDOW_HEIGHT_2K)) {
						window.create(sf::VideoMode::getFullscreenModes()[0], "Lucy's Labyrinth", sf::Style::Fullscreen);
					}
					else {
						window.create(sf::VideoMode(WINDOW_WIDTH_2K, WINDOW_HEIGHT_2K), "Lucy's Labyrinth", sf::Style::Default);
					}
                    window.setVerticalSyncEnabled(true);
                }
                if (maze.getDialogueBoxDisplayed() && maze.dialogueBoxState == 2) {
